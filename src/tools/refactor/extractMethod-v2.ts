...
export const refactor_extractMethod_v2Tool: Tool = {
  name: 'refactor_extractMethod_v2',
  description: 'Extract code into a new method/function (AI-optimized, symbol-based)',
  inputSchema: {
    type: 'object',
    properties: {
      containingFunction: {
