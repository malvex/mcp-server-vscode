...
export const refactor_rename_v2Tool: Tool = {
  name: 'refactor_rename_v2',
  description: 'Rename a symbol across all files in the workspace (AI-optimized, symbol-based)',
  inputSchema: {
    type: 'object',
    properties: {
      symbol: {
